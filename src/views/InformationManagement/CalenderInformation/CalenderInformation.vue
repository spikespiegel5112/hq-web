...
import {
  infoManagementCalendarInfoGetPageRequest,
  infoManagementCalendarInfoDeleteRequest,
  infoManagementCalendarInfoSaveRequest,
  infoManagementCalendarInfoHandleRequest,
} from "@/api/management";
...
const handleSubmit = (formData: any) => {
  infoManagementCalendarInfoSaveRequest(formData)
    .then((response: any) => {
...
const handleSubmitDisposal = (formData: any) => {
  infoManagementCalendarInfoHandleRequest(formData)
    .then((response: any) => {
      global.$message.success("操作成功");
      getData();
    })
