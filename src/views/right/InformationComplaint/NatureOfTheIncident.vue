<template>
  <div class="natureoftheincident">
    <div id="natureoftheincident"></div>
  </div>
</template>
...
let myChart: any;
const initChart = () => {
  var chartDom = document.getElementById('natureoftheincident');
...
const getData = () => {
  screenComplaintInfoRequest({
    ...
    .then((response: any) => {
      ...
      console.log('=====screenComplaintInfoRequest=====');
