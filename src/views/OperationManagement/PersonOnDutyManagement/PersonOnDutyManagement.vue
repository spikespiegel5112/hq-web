<template>
  <div class="common_table_wrapper">
    <FilterTool
      ...
      @onReset="handleReset"
      :disabled="!global.$checkAuth(global, 'operationManagement:dutyStaff:getPage')"
      v-model="queryFormData"
    ></FilterTool>
    <div class="common_tableoperation_wrapper">
      <a-space size="middle" wrap>
        <ImportButton
          :action="operationManagementDutyStaffImportExcelRequest"
        @success="() => getData()"
          :disabled="
        ...
        <a-button
          class="add"
          @click="handleAdd"
          :disabled="!global.$checkAuth(global, 'operationManagement:dutyStaff:save')"
        >
          新增
        </a-button>
      </a-space>
...
import {
  ...
  operationManagementDutyStaffImportExcelRequest,
} from "@/api/management";
...
const getData = () => {
  if (!global.$checkAuth(global, "operationManagement:dutyStaff:getPage")) return;
